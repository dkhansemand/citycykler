<?php
    ...
    if(isset($POST['btnSubmit'])){
        ...
        if(sizeof($error) === 0){
            ...
            {
                Brands::New($brandName);
                $success = 'Mærket er nu blevet tilføjet';
                unset($POST);
            }else{
    ...
    <div class="mdl-grid">
        ...
        <div class="mdl-cell mdl-cell--12-col">
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <input class="mdl-textfield__input" type="text" id="brandName" name="brandName" value="<?=@$POST['brandName']?>" required>
